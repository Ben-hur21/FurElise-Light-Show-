...
// Treble clef notes of the melody followed by the duration
const int trebleMelody[] PROGMEM = {
...
// Bass clef notes of the melody followed by the duration
const int bassMelody[] PROGMEM = {
  // Fur Elise - Ludwig van Beethoven
  // Bass clef part
  NOTE_A2, 16, NOTE_E3, 16, NOTE_A3, 16, NOTE_E3, 16, NOTE_A3, 16, NOTE_E3, 16, NOTE_A3, 16, NOTE_E3, 16, NOTE_A3, 16,
  NOTE_E3, 16, NOTE_A3, 16, NOTE_E3, 16, NOTE_A3, 16, NOTE_E3, 16, NOTE_A3, 16, NOTE_E3, 16, NOTE_A3, 16, NOTE_E3, 16,
  NOTE_B2, 16, NOTE_F3, 16, NOTE_B3, 16, NOTE_F3, 16, NOTE_B3, 16, NOTE_F3, 16, NOTE_B3, 16, NOTE_F3, 16, NOTE_B3, 16,
  NOTE_F3, 16, NOTE_B3, 16, NOTE_F3, 16, NOTE_B3, 16, NOTE_F3, 16, NOTE_B3, 16, NOTE_F3, 16, NOTE_B3, 16, NOTE_F3, 16,
  NOTE_C3, 16, NOTE_G3, 16, NOTE_C4, 16, NOTE_G3, 16, NOTE_C4, 16, NOTE_G3, 16, NOTE_C4, 16, NOTE_G3, 16, NOTE_C4, 16,
  NOTE_G3, 16, NOTE_C4, 16, NOTE_G3, 16, NOTE_C4, 16, NOTE_G3, 16, NOTE_C4, 16, NOTE_G3, 16, NOTE_C4, 16, NOTE_G3, 16,
  NOTE_D3, 16, NOTE_A3, 16, NOTE_D4, 16, NOTE_A3, 16, NOTE_D4, 16, NOTE_A3, 16, NOTE_D4, 16, NOTE_A3, 16, NOTE_D4, 16,
  NOTE_A3, 16, NOTE_D4, 16, NOTE_A3, 16, NOTE_D4, 16, NOTE_A3, 16, NOTE_D4, 16, NOTE_A3, 16, NOTE_D4, 16, NOTE_A3, 16,
  NOTE_E3, 16, NOTE_B3, 16, NOTE_E4, 16, NOTE_B3, 16, NOTE_E4, 16, NOTE_B3, 16, NOTE_E4, 16, NOTE_B3, 16, NOTE_E4, 16,
  NOTE_B3, 16, NOTE_E4, 16, NOTE_B3, 16, NOTE_E4, 16, NOTE_B3, 16, NOTE_E4, 16, NOTE_B3, 16, NOTE_E4, 16, NOTE_B3, 16,
};

// sizeof gives the number of bytes, each int value is composed of two bytes (16 bits)
// there are two values per note (pitch and duration), so for each note there are four bytes
int trebleNotes = sizeof(trebleMelody) / sizeof(trebleMelody[0]) / 2;
int bassNotes = sizeof(bassMelody) / sizeof(bassMelody[0]) / 2;
...
void playMelody(const int* melody, int notes) {
  for (int thisNote = 0; thisNote < notes * 2; thisNote = thisNote + 2) {
    ...
    // Light up LEDs in sync with the music
    if (note == NOTE_E5 || note == NOTE_C5 || note == NOTE_E4 || note == NOTE_C4) {
      digitalWrite(LED1, HIGH);
    } else if (note == NOTE_A4 || note == NOTE_B4 || note == NOTE_A3 || note == NOTE_B3) {
      digitalWrite(LED2, HIGH);
    } else if (note == NOTE_D5 || note == NOTE_F5 || note == NOTE_D4 || note == NOTE_F4) {
      digitalWrite(LED3, HIGH);
    } else if (note == NOTE_G5 || note == NOTE_FS5 || note == NOTE_G4 || note == NOTE_FS4) {
...
void loop() {
  playMelody(trebleMelody, trebleNotes);
  playMelody(bassMelody, bassNotes);
}